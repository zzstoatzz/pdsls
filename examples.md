...
## read anyone's bio
```bash
uvx pdsx --repo did:plc:o53crari67ge7bvbv273lxln list app.bsky.actor.profile -o json | jq -r '.[0].description'
```
...
## read anyone's posts
```bash
uvx pdsx -r did:plc:o53crari67ge7bvbv273lxln list app.bsky.feed.post --limit 5 -o json | jq -r '.[] | .text'
```
