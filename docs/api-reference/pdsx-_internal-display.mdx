...
### `display_success` <sup><a href="https://github.com/zzstoatzz/pdsx/blob/main/src/pdsx/_internal/display.py#L162" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
